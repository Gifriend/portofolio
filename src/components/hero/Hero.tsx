  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute left-0 top-[50%] hidden h-[121px] w-[250px] flex-col items-start justify-center rounded-br-full rounded-tr-full bg-zinc-800 px-5 dark:bg-zinc-100 lg:flex"
      >
